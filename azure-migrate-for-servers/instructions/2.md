...
4. Accept license terms by clicking the check box available under **Accept license terms** section, wait for 2-3 minutes and then Click on **Continue** button once updates are successfully installed.
	...
	> If the continue button is not active yet, refresh the tab
