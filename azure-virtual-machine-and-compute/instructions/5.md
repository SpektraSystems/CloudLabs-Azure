...
1. On the Remote desktop connection window paste the **Public IP address (1)** of the virtual machine we copied in *Step 12* and click on **Connect (2)**.

     ![](../instructions/images/Lab5-07.png)

1. Click on **More choices**.

     ![](../instructions/images/Lab5-08.png)

1. Select **Use a different account**.

     ![](../instructions/images/Lab5-09.png)

1. Enter the following credentials and click on **OK** to log in to the RDP session.
...
1. Open a **new browser window** and **resize** it if necessary in the connected DEMOLABVM01.

1. In the **address bar**, paste the **public IP address (1)** and press **Enter**.
