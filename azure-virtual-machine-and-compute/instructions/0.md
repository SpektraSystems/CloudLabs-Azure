...
5. Click on **Next**. Now on the **Create virtual network - Security** tab leave the default option for **BastionHost** ,**firewall** and **DDoS Protection** , then click on **Next**.
