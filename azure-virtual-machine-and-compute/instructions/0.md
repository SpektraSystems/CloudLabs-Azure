...
1. On the **Create virtual network - IP Addresses** tab, enter **10.2.0.0/24 (1)** under **IPv4 address space**. Then, select **Add subnet (2)**.
 
   ![](images/img2.png)

1.  On **Add subnet** tab enetr the following details and click **Add (3)**.
   
      - Name: **demolabsubnet (1)**
      
      - Subnet address range: **10.2.0.0/26 (2)**
      
     ![](images/img-3.png)

1. Click on **Next : Security >**. Now on the **Create virtual network - Security** tab leave the default option for **DDoS Protection** and **firewall**, then click on **Review + Create**.
