...
5. Click on **Next**. Now on the **Create virtual network - Security** tab leave the default option for **DDoS Protection** and **firewall**, then click on **Next**.

    ![](images/VMC-E1-S5.png)

6. On the **Create virtual network - IP Addresses** tab, click on **Add IPv4 address space (1),** enter **10.2.0.0** and select **/24(256 addresses) (2)** from the drop down. Then, select **Add subnet (2)**.
 
   ![](images/VMC-E1-S6.png)

7.  On **Add subnet** tab enetr the following details and click **Add (3)**.
