...
5. On the **Basics** tab of *Create virtual network* blade, provide the following information:
    ...
    -  Click on **Next (5)**.
       ...
       ![](../instructions/images/lab1-4.png)
    
6. On the **Security** tab, keep all options at their **default** settings, then click **Next**.

    ![](images/lab1-5a.png)

7. On the **IP addresses** tab, scroll down and click **Add IPv4 address space (1)**. In the second box, enter **10.2.0.0** and select **/24 for 256 addresses (2)** from the dropdown. Next, scroll up and click **+ Add a subnet (3)**.

    ![](images/images/Lab0-05.png)
...
8.  On **Add a subnet** tab, provide the following details: 
      ...
      - Click on **Add (5)**. 
        ...
        ![](../instructions/images/images/Lab0-06.png)
...
<validation step="1c36f4aa-5872-45d1-b555-c6e886004442" />
...
![Launch Azure Portal](../instructions/images/next.png)