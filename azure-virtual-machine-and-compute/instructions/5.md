...
9. In the **You have no storage mounted** panel, follow the below steps:
    ...
    - Under **Storage account**, select **Create new** and give the name as **demolabstorage<inject key="DeploymentID" />**
...
10. Go to **azvmrg-<inject key="DeploymentID" />** Resource group and select **DEMOLABVM01** virtual machine.
