...
11. Then navigate back to **CORS**(Cross-Origin Resource Sharing) under API and update the *Allowed Origins* with the copied website URL and then click **Save**.

    ![CORS](images/CORS.png)

12. Open the copied URL through a tab in the browser and enter the Function App name and click on **Connect**. 
