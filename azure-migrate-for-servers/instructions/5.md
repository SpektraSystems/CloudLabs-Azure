...
1. On the **Disks** blade, leave everything as default and click on **Next: Review + Start replication** but don't click on **Replicate** button since we have already setup replication of a VM for you..
