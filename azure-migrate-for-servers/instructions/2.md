...
7. Now enter the following password and click on **Sign in**.
   * **Password**: <inject key="AzureAdUserPassword"></inject>	
   ...
   >If you see session timeout message at the top of the page, click on **login** again and continue with step 8.
   
      ![](image/loginagain.png)
   
8. Then scroll down and expand **Register with Azure Migrate** section by clicking on downward arrow icon.

      ![](image/continue.png)
        
9. **Click** on the **Subscription** dropdown and select the available subscription from the list.
10. Select your **Migrate project** from the dropdown.
11. **Enter Appliance Name:** **mig**
12. Click on **Register**.

      ![](image/register.png)

13. After it shows **Successfully registered**, click on **Continue**.

      ![](image/successreg.png)

14. Under *Specify the list of Hyper-v hosts* **click** on **Add**. Now you will be redirected to the **Specify credentials to connect to Hyper-V Host and Clusters** section, for the Hyper-V host credentials enter the following:
...
16. Under *Specify the list of Hyper-v hosts*, again **click** on **Add**.
17. Copy the value of **HyperVHostIP** from environment details page and **click** on **Validate**.

      ![](image/hostvmip.png)

18. Then, **click** on **Save and start discovery**. It will take 2-3 minutes for initiating discovery and configuring appliance and another 3-5 minutes to complete.
...
19. Once the appliance configuration is completed as shown in the image below, continue to the next exercise.
