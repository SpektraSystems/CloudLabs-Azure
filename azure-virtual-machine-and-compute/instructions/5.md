...
1. To launch the VM using a remote desktop connection follow the below instructions:  
    ...
    - ### For Mac users:
      ...
      >**Note:** If required, please refer the following document https://help.cloudlabs.ai/docs/access-and-manage-lab
    
    - You must first download the **Microsoft Remote Desktop** application from the Mac App Store in order to begin using Microsoft Remote Desktop.
