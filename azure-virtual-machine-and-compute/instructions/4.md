...
5. On the **DEMOLABVM01** blade in the right pane, go to **Overview** section and note that you can view the following information about the VM:
...
7. On the **Network interface** blade,go to **Overview** section and note that you can view the following information about the network interface:
