...
4.	In the **Allowed virtual machine SKUs** blade, note the list of non-compliant resources. Then click on the ellipsis ![ellipse icon](.\img\ellipse.png) to the right of the first resource in the list and select **View compliance details**
...
8.	In the **Audit Storage Accounts Exposed to Public Networks** blade, note the list of non-compliant resources. Then click on the ellipsis ![ellipse icon](.\img\ellipse.png) to the right of the first resource in the list and select **View compliance details**
...
10.	Back in the **Audit Storage Accounts Exposed to Public Networks** blade, click on the ellipsis ![ellipse icon](.\img\ellipse.png) to the right of the first resource in the list and select **View resource**
