...
17. Click OK. Try again & Click Actions and accept the warnings.<br/>
   <img src="images/sqlvm.jpg"/><br/>
...
18. Use **HammerDB** to create transaction load<br/>
   <img src="images/sqlvm.jpg"/><br/>
19. Double click on SQL Server and click OK, and OK on the confirm popup. Drill into SQL Server \ TPC-C \ Schema Build and double click on Options. Modify the Build Options for the following:<br/>
