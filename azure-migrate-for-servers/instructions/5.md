...
9. Click the **Resource group** dropdown, Select **migrate-deploymentID** from the list

10. Click the **Replication Storage Account** dropdown and select the storage account starting with '**sa**' from the dropdown list 
