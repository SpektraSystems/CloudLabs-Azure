...
### Deploy a Virtual Machine
 ...
 3. In the search box, type **Virtual Machine (1)** and select  **Virtual Machine (2)** to open it.

      ![](../instructions/images/lab2-image1.png)

 4. Select **Create (1)** drop down and then choose **Virtual Machine (2)** from the options.
...
An operating system disk hosts the VM's operating system, and a temporary disk is used for operations such as temporary data processing. Later in the lab, you will add an additional data disk for installing applications and storing data. 
...
7. On the **Networking** tab, set the following configurations:
...
9. On the **Monitoring** tab, leave the default options and click on **Next : Advanced >**
